...
class CardScreen : Screen {
    ...
    override fun Content() {
        ...
        Box(
            modifier = Modifier.fillMaxSize().background(color = Color.colorBackground)
        ) {
            ...
            if (list.size > 0) {
                LazyVerticalGrid(
                    columns = GridCells.Fixed(upGrid), modifier = Modifier.fillMaxSize()
                ) {
                    items(list.size) {
                        val card = list[it]
                        ...
                        if (upGrid == 1) {
                            KamelImage(
                                ...
                                modifier = Modifier.fillMaxWidth()
                                    .background(color = Color.colorSurface),
            ...
            Row(
                ...
                Image(
                    ...
                    modifier = Modifier.padding(16.dp, 48.dp)
                        .width(36.dp)
                        .height(36.dp)
                        .padding(4.dp)
                        .clickable {
